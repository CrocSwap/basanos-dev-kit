...
class Consumer:
    ...
    def read_result(self, descriptor: bytes) -> c.ResultV4:
    ...
    def tokens(self, result: c.ResultV4, *, vocab: int) -> list[int]:
...
def usable_tokens(result: c.ResultV4, *, vocab: int) -> list[int]:
